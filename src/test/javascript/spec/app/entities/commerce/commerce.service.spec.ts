...
describe('Service Tests', () => {
  describe('Commerce Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Commerce(123, 'AAAAAAA', Theme.RESTAURANT, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Commerce', async () => {
      ...
      it('should not update a Commerce', async () => {
      ...
      it('should partial update a Commerce', async () => {
      ...
      it('should not partial update a Commerce', async () => {
      ...
      it('should not return a list of Commerce', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Commerce', async () => {
