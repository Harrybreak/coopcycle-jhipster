...
/**
 * REST controller for managing {@link polytech.info4.gl.domain.Maintenance}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Maintenance> partialUpdateMaintenance(
        ...
        Optional<Maintenance> result = maintenanceRepository
            ...
            .map(existingMaintenance -> {
                if (maintenance.getCategorie() != null) {
                    existingMaintenance.setCategorie(maintenance.getCategorie());
                }
