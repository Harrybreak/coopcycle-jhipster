...
/**
 * REST controller for managing {@link polytech.info4.gl.domain.Cooperative}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Cooperative> partialUpdateCooperative(
        ...
        Optional<Cooperative> result = cooperativeRepository
            ...
            .map(existingCooperative -> {
                ...
                if (cooperative.getCanton() != null) {
                    existingCooperative.setCanton(cooperative.getCanton());
                }
